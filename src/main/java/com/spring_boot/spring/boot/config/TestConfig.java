...
import com.spring_boot.spring.boot.entities.Payment;
import com.spring_boot.spring.boot.entities.Product;
import com.spring_boot.spring.boot.entities.User;
import com.spring_boot.spring.boot.entities.enums.OrderStatus;
import com.spring_boot.spring.boot.repositories.CategoryRepository;
import com.spring_boot.spring.boot.repositories.OrderItemRepository;
import com.spring_boot.spring.boot.repositories.OrderRepository;
import com.spring_boot.spring.boot.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p1 = new Product(null, "The lord of the Rings", "Lorem ipsum color sit amet, consectetur.", 90.5, "");
		Product p2 = new Product(null, "Smart TV", "Nulla eu imperdiet purus. Maecenas ante", 2190.0, "");
		Product p3 = new Product(null, "Macbook Pro", "Nam eleifend maximus tortor, at mollis.", 1250.0, "");
		Product p4 = new Product(null, "PC Gamer", "Donex alliquet odio ac rhoncus cursus", 1200.0, "");
